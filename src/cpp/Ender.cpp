...
namespace Sage
{
	Ender::Ender(const std::string& filepath, unsigned int sprite_size_x, unsigned int sprite_size_y, double quad_size_x, double quad_size_y, double quad_loc_x, double quad_loc_y, unsigned int draw_layer, double initial_vel_x, double initial_vel_y)
		:
		Collidable("ender_" + std::to_string(ID_factory++) + '_' + filepath, draw_layer),
	...
	Ender::Ender(double quad_loc_x, double quad_loc_y, double quad_size_x, double quad_size_y, unsigned int draw_layer, double initial_vel_x, double initial_vel_y)
		...
		quad(Quad{ glm::vec4{1.0, 0.519, 0.621, 1.0}, quad_size_x, quad_size_y, quad_loc_x, quad_loc_y }),
		vel(initial_vel_x, initial_vel_y)
	{
